...
<div class="box">
    ...
    <a href="add.php"style="text-decoration: none" style="color: aliceblue;"  ><img width="40" height="40" src="https://cdn-icons-png.flaticon.com/512/1828/1828817.png"></a>
    <br>
    <br>
<table class="table" >
    <thead>
...
$conn = mysqli_connect("localhost", "root", "lamp789","abityrient")  or die("Невозможно подключиться к MySQL серверу!");
...
$sql = "SELECT id, Name, Familia, Otchestvo, Ball from Anketa";
